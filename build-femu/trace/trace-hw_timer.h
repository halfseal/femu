...
extern TraceEvent _TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_EVENT;
...
extern uint16_t _TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_DSTATE;
...
#define TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_ENABLED 1
...
static inline void _nocheck__trace_hpet_ram_write_tn_cfg(void)
{
...
#line 111 "../hw/timer/trace-events"
            qemu_log("%d@%zu.%06zu:hpet_ram_write_tn_cfg " "hpet_ram_writel HPET_TN_CFG" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     );
...
#line 111 "../hw/timer/trace-events"
            qemu_log("hpet_ram_write_tn_cfg " "hpet_ram_writel HPET_TN_CFG" "\n");
#line 2736 "trace/trace-hw_timer.h"
        }
    }
}

static inline void trace_hpet_ram_write_tn_cfg(void)
{
    if (true) {
        _nocheck__trace_hpet_ram_write_tn_cfg();
    }
}

#define TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_HPET_RAM_WRITE_INVALID_TN_CFG) || \
    false)

static inline void _nocheck__trace_hpet_ram_write_invalid_tn_cfg(uint8_t reg_off)
{
    if (trace_event_get_state(TRACE_HPET_RAM_WRITE_INVALID_TN_CFG) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 112 "../hw/timer/trace-events"
            qemu_log("%d@%zu.%06zu:hpet_ram_write_invalid_tn_cfg " "invalid HPET_TN_CFG + %" PRIu8 " write" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , reg_off);
...
#line 112 "../hw/timer/trace-events"
            qemu_log("hpet_ram_write_invalid_tn_cfg " "invalid HPET_TN_CFG + %" PRIu8 " write" "\n", reg_off);
#line 2767 "trace/trace-hw_timer.h"
        }
    }
}

static inline void trace_hpet_ram_write_invalid_tn_cfg(uint8_t reg_off)
{
    if (true) {
        _nocheck__trace_hpet_ram_write_invalid_tn_cfg(reg_off);
    }
}
