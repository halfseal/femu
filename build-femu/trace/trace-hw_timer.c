...
uint16_t _TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_DSTATE;
...
TraceEvent _TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_EVENT = {
    .id = 0,
    .name = "hpet_ram_write_invalid_tn_cfg",
    .sstate = TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_ENABLED,
    .dstate = &_TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_DSTATE 
};
...
TraceEvent *hw_timer_trace_events[] = {
    ...
    &_TRACE_HPET_RAM_WRITE_INVALID_TN_CFG_EVENT,
