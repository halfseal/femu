...
uint16_t _TRACE_XEN_INIT_RAM_DSTATE;
...
TraceEvent _TRACE_XEN_INIT_RAM_EVENT = {
    .id = 0,
    .name = "xen_init_ram",
    .sstate = TRACE_XEN_INIT_RAM_ENABLED,
    .dstate = &_TRACE_XEN_INIT_RAM_DSTATE 
};
