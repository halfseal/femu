...
uint16_t _TRACE_LOONGARCH_IPI_READ_DSTATE;
uint16_t _TRACE_LOONGARCH_IPI_WRITE_DSTATE;
uint16_t _TRACE_LOONGARCH_IPI_UNSUPPORTED_CPUID_DSTATE;
...
TraceEvent _TRACE_LOONGARCH_IPI_READ_EVENT = {
    .id = 0,
    .name = "loongarch_ipi_read",
    .sstate = TRACE_LOONGARCH_IPI_READ_ENABLED,
    .dstate = &_TRACE_LOONGARCH_IPI_READ_DSTATE 
};
TraceEvent _TRACE_LOONGARCH_IPI_WRITE_EVENT = {
    .id = 0,
    .name = "loongarch_ipi_write",
    .sstate = TRACE_LOONGARCH_IPI_WRITE_ENABLED,
    .dstate = &_TRACE_LOONGARCH_IPI_WRITE_DSTATE 
};
TraceEvent _TRACE_LOONGARCH_IPI_UNSUPPORTED_CPUID_EVENT = {
    .id = 0,
    .name = "loongarch_ipi_unsupported_cpuid",
    .sstate = TRACE_LOONGARCH_IPI_UNSUPPORTED_CPUID_ENABLED,
    .dstate = &_TRACE_LOONGARCH_IPI_UNSUPPORTED_CPUID_DSTATE 
};
...
TraceEvent *hw_intc_trace_events[] = {
    ...
    &_TRACE_LOONGARCH_IPI_READ_EVENT,
    &_TRACE_LOONGARCH_IPI_WRITE_EVENT,
