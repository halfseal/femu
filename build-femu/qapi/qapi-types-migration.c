...
const QEnumLookup MigrationCapability_lookup = {
    ...
    .special_features = (const unsigned char[MIGRATION_CAPABILITY__MAX]) {
        [MIGRATION_CAPABILITY_COMPRESS] = 1u << QAPI_DEPRECATED,
        [MIGRATION_CAPABILITY_X_COLO] = 1u << QAPI_UNSTABLE,
        [MIGRATION_CAPABILITY_BLOCK] = 1u << QAPI_DEPRECATED,
...
const QEnumLookup MigrationParameter_lookup = {
    ...
    .special_features = (const unsigned char[MIGRATION_PARAMETER__MAX]) {
        [MIGRATION_PARAMETER_COMPRESS_LEVEL] = 1u << QAPI_DEPRECATED,
        [MIGRATION_PARAMETER_COMPRESS_THREADS] = 1u << QAPI_DEPRECATED,
        [MIGRATION_PARAMETER_DECOMPRESS_THREADS] = 1u << QAPI_DEPRECATED,
        [MIGRATION_PARAMETER_COMPRESS_WAIT_THREAD] = 1u << QAPI_DEPRECATED,
        [MIGRATION_PARAMETER_X_CHECKPOINT_DELAY] = 1u << QAPI_UNSTABLE,
        [MIGRATION_PARAMETER_BLOCK_INCREMENTAL] = 1u << QAPI_DEPRECATED,
